...
while read subject; do
  for iRun in {1..3}; do
    ...
    #noTD
    rm -r ${featDir}/${subject}_run-0${iRun}_block_fwhm${fwhm}_noTD.feat/reg_standard
  ...
  #scp ${featDir}/${subject}_motionLocaliser_fwhm${fwhm}_nofmaps.feat/mean_func.nii.gz ${featDir}/${subject}_motionLocaliser_fwhm${fwhm}_nofmaps.feat/reg/standard.nii.gz
