...
while read subject; do
  if [ "$subject" = "sub-09" ] || [ "$subject" = "sub-12" ] || [ "$subject" = "sub-16" ] || [ "$subject" = "sub-26" ]; then
    ...
    # standardScript="memsamp_block_lock2resp_2ndlvl_4runs_fwhm${fwhm}"
    standardScript="memsamp_block_feed_2ndlvl_feed_4runs_fwhm${fwhm}"
    ...
    # standardScript="memsamp_block_lock2resp_2ndlvl_fwhm${fwhm}"
    standardScript="memsamp_block_feed_2ndlvl_fwhm${fwhm}"
