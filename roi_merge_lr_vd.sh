...
while read subject; do
  ...
  fslmaths ${roiList} ${roiDir}/${subject}_visRois_lh.nii.gz
  roiList=`cat ${roiDir}/visual_rois_rh.txt`
  fslmaths ${roiList} ${roiDir}/${subject}_visRois_rh.nii.gz
  fslmaths ${roiDir}/${subject}_visRois_lh.nii.gz -add ${roiDir}/${subject}_visRois_rh.nii.gz ${roiDir}/${subject}_visRois_lrh.nii.gz
  roiList=`cat ${roiDir}/ips_rois_lh.txt`
  fslmaths ${roiList} ${roiDir}/${subject}_ipsRois_lh.nii.gz
