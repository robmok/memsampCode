...
while read subject; do
  ...
  echo "/Users/robert.mok/Documents/Postdoc_ucl/memsamp_fMRI/memsampFSL/${subject}_block_fwhm${fwhm}_2ndlvl.gfeat/cope${iCope}.feat/stats/cope${iCope}.nii.gz" >> ${wd}/gfeatDirLists/gfeat_fsl_dirs_cope${iCope}_fwhm${fwhm}.txt
  ...
  echo "/Users/robert.mok/Documents/Postdoc_ucl/memsamp_fMRI/memsampFSL/${subject}_motionLocaliser_fwhm${fwhm}.feat" >> ${wd}/gfeatDirLists/gfeat_fsl_dirs_motionLoc_fwhm${fwhm}.txt
  echo "/Users/robert.mok/Documents/Postdoc_ucl/memsamp_fMRI/memsampFSL/${subject}_exemplarLocaliser_fwhm${fwhm}.feat" >> ${wd}/gfeatDirLists/gfeat_fsl_dirs_exemplarLoc_fwhm${fwhm}.txt
