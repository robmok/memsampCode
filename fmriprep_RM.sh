...
fmriprep-docker --fs-license-file ${FS_LICENSE} ${inDir} ${outDir} participant --participant_label 24 --output-space T1w template --fs-no-reconall --mem_mb 32000 --nthreads 6 -w ${hd}/fmriprep_scratch_nofmaps
