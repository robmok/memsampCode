...
fwhm=6 #6/8
standardScript="memsamp_fsl_exemplarLocaliser_fwhm6"

cd ${wd}
while read subject; do
  epi_file="${bidsDir}/${subject}/func/${subject}_task-exemplarLocaliser_bold.nii.gz"
  ...
  sed -e s:sub-01:${subject}:g \
    ...
    <${fsfDir}/${standardScript}.fsf >${fsfDir}/run_memsamp_fsl_exemplarLocaliser_fwhm${fwhm}_${subject}.fsf
  feat ${fsfDir}/run_memsamp_fsl_exemplarLocaliser_fwhm${fwhm}_${subject}.fsf
