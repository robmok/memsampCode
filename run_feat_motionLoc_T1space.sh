...
#*********************************
#only visual on/off, no contrasts#
#*********************************

fwhm=5
standardScript="memsamp_motionLocaliser_T1_fwhm5"
#standardScript="memsamp_motionLocaliser_T1_fwhm5_brainmask" #very similar if not same
...
while read subject; do
  ...
  sed -e s:sub-01:${subject}:g \
    ...
    <${fsfDir}/${standardScript}.fsf >${fsfDir}/run_memsamp_motionLocaliser_T1_fwhm${fwhm}_${subject}.fsf
  feat ${fsfDir}/run_memsamp_motionLocaliser_T1_fwhm${fwhm}_${subject}.fsf
